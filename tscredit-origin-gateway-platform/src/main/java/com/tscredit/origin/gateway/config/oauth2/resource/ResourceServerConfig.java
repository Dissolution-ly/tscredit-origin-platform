...
//            String[] strings = authUrlWhiteListProperties.getStaticFiles().toArray(new String[authUrlWhiteListProperties.getStaticFiles().size()]);
//            http.authorizeExchange().pathMatchers(strings).permitAll();
//        }
//        // 4、判断是否有静态文件
