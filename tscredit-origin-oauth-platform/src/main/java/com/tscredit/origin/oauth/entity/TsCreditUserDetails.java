package com.tscredit.origin.oauth.entity;
 ...
 */
@Getter
public class TsCreditUserDetails extends User {
    ...
    public TsCreditUserDetails(Long id, String tenantId, String oauthId, String nickname, String realName,
